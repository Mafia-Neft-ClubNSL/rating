...
(function(modules) {
    ...
    "56d7" : function(vdwB, d, $) {
        ...
        var render = function() {
            ...
            }, [self._v("\u0418\u0433\u0440 \u0434\u043b\u044f \u043f\u043e\u043f\u0430\u0434\u0430\u043d\u0438\u044f \u0432 \u0440\u0435\u0439\u0442\u0438\u043d\u0433: " + self._s(self.gamesForRatingCount) + " (33%)")])]), h("md-tab", {
                attrs : {
                    id : "tab-roles",
                    "md-label" : "\u041f\u043e \u0440\u043e\u043b\u044f\u043c"
                }
                        ...
                        for (; 1;) {
                            switch(_context10.prev = _context10.next) {
                                case 0:
                                    ...
                                    e = result[1];
                                case 4:
                                    return property = ("0" + e).slice(-2), ajaxPostUrl = "https://mafia-neft-clubnsl.github.io/rating/{month}-games.json".replace("{month}", value + "-" + property), _context10.next = 8, fetch(ajaxPostUrl);
                                case 8:
